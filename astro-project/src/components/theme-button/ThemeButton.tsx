...
export function ThemeButton() {
  const [isDarkTheme, setIsDarkTheme] = createSignal(getThemeFromStorage())
  ...
  return (
    <button onclick={changeTheme} class={styles["themeButton"]}>
      <svg class={styles["themeButton-icon"]} xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 -960 960 960" width="48">
        <Show
          when={isDarkTheme()}
          fallback={<path d="M480-120q-150 0-255-105T120-480q0-135 79.5-229T408-830q41-8 56 14t-1 60q-9 23-14 47t-5 49q0 90 63 153t153 63q25 0 48.5-4.5T754-461q43-16 64 1.5t11 59.5q-27 121-121 200.5T480-120Zm0-60q109 0 190-67.5T771-406q-25 11-53.667 16.5Q688.667-384 660-384q-114.689 0-195.345-80.655Q384-545.311 384-660q0-24 5-51.5t18-62.5q-98 27-162.5 109.5T180-480q0 125 87.5 212.5T480-180Zm-4-297Z" />}
        >
